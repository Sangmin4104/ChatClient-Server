...
public class ServerThread extends Thread
{
    ...
    private static final int YES_CAHTBAN = 2071;
            ...
            while(true){
                ...
                switch(command){
                    ...
                    case REQ_POPMESSAGE : {
                        ...
                        st_buffer.setLength(0);
                        st_buffer.append(YES_POPMESSAGE); // 2081
                        st_buffer.append(SEPARATOR);
                        st_buffer.append(id);
                        st_buffer.append(SEPARATOR);
                        st_buffer.append(st_roomNumber);
                        ...
                        try{
                            ...
                            TimerTask task = new TimerTask() {
                                ...
                                public void run() {
                                    if (!data.isEmpty()) {
                                        st_buffer.setLength(0);
                                        st_buffer.append(YES_POPMESSAGE + SEPARATOR + id + SEPARATOR + st_roomNumber + SEPARATOR + "'" + data + "' 메시지가 삭제되었습니다.");
                                        String word = st_buffer.toString();
                    ...
                    case REQ_CHATBAN: {
                        ...
                        if ((client = (ServerThread)room.get(id)) != null) {
                            ...
                            this.st_buffer.append(YES_CAHTBAN);
...
//                            this.send(this.st_buffer.toString());
                            this.broadcast(this.st_buffer.toString(), roomNumber);
                        } else {
                            this.st_buffer.setLength(0);
